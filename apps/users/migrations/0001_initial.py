    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job', models.CharField(blank=True, choices=[('hd', '后端开发工程师'), ('qd', '前端开发工程师'), ('yd', '移动开发工程师'), ('test', '软件测试工程师'), ('linux', 'Linux系统工程师'), ('qz', '全栈开发工程师'), ('sf', '算法工程师'), ('student', '学生')], default='', max_length=10, verbose_name='职位')),
                ...
                ('image', models.ImageField(default='image/default_tx.png', upload_to='users/images', verbose_name='用户头像')),
